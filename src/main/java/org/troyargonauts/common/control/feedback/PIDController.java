...
package org.troyargonauts.common.control.feedback;

import org.troyargonauts.common.control.Controller;
import org.troyargonauts.common.math.OMath;
import org.troyargonauts.common.network.SmartNumber;
import org.troyargonauts.common.streams.filters.IFilter;
import org.troyargonauts.common.streams.filters.IFilterGroup;
    ...
    public PIDController setIntegratorFilter(Number range, Number limit) {
        mIFilter =
                new IFilterGroup(
                        ...
                        x -> limit.doubleValue() <= 0 ? x : OMath.clamp(x, limit.doubleValue()));
        return this;
    }
