...
public final class AutoGamepad extends Gamepad {
    ...
    public double getLeftX() {
        return OMath.clamp(getDetectedGamepad().getLeftX(), -1.0, 1.0);
    }

    public double getLeftY() {
        return OMath.clamp(getDetectedGamepad().getLeftY(), -1.0, 1.0);
    }

    // Right Stick //
    public double getRightX() {
        return OMath.clamp(getDetectedGamepad().getRightX(), -1.0, 1.0);
    }

    public double getRightY() {
        return OMath.clamp(getDetectedGamepad().getRightY(), -1.0, 1.0);
    }
    ...
    public double getLeftTrigger() {
        return OMath.clamp(getDetectedGamepad().getLeftTrigger(), 0.0, 1.0);
    }

    public double getRightTrigger() {
        return OMath.clamp(getDetectedGamepad().getRightTrigger(), 0.0, 1.0);
    }
