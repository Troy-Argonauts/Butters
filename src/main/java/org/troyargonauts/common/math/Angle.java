...
public final class Angle {
     ...
     */
    private static double normalizeValue(double radians, double center, double range) {
        return radians - range * Math.round((radians - center) / range);
    }
    ...
    public String toString() {
        ...
        if (STRING_RADIANS) {
            out.append(OMath.round(this.toRadians(), STRING_SIGFIGS)).append("pi, ");
        }

        out.append(OMath.round(this.toDegrees(), STRING_SIGFIGS)).append("deg)");
