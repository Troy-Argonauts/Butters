...
public class FloorShoot extends SequentialCommandGroup {
    public FloorShoot() {
        super(
                new InstantCommand(() -> System.out.println("Floor Shoot")),
                ...
                new WaitCommand(1),
                new InstantCommand(() -> Robot.getWrist().setDesiredTarget(Wrist.WristState.FLOOR_SHOOT), Robot.getWrist())
        );
    }
}